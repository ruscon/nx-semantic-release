...
describe.skip('Setup project', () => {
  ...
  it('should setup project', async () => {
    await runNxCommandAsync(
      `generate @ruscon/nx-semantic-release-pnpm:setup-project ${project}`
    );
  ...
  it('should setup project using given configuration', async () => {
    await runNxCommandAsync(
      `generate @ruscon/nx-semantic-release-pnpm:setup-project ${project} --github=false --changelog=false --npm=false --tagFormat=test`
    );
  ...
  it('should create valid project configuration that can be released', async () => {
    await runNxCommandAsync(
      `generate @ruscon/nx-semantic-release-pnpm:setup-project ${project} --github=false --changelog=true --npm=true`
    );
