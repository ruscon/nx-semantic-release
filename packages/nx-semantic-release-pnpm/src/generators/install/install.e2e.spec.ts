...
describe.skip('Installer', () => {
  ...
  it('should create example', async () => {
    await runNxCommandAsync(
      `generate @ruscon/nx-semantic-release-pnpm:install --repositoryUrl=test --enforceConventionalCommits=false`
    );
  ...
  describe('--enforceConventionalCommits', () => {
    it('should setup project to enforce conventional commits', async () => {
      await runNxCommandAsync(
        `generate @ruscon/nx-semantic-release-pnpm:install --repositoryUrl=test --enforceConventionalCommits`
      );
