...
describe('Installer', () => {
  ...
  it('should create example', async () => {
    await runNxCommandAsync(
      `generate @goestav.x/nx-semantic-release:install --repositoryUrl=test --enforceConventionalCommits=false`
    );
  ...
  describe('--enforceConventionalCommits', () => {
    it('should setup project to enforce conventional commits', async () => {
      await runNxCommandAsync(
        `generate @goestav.x/nx-semantic-release:install --repositoryUrl=test --enforceConventionalCommits`
      );
