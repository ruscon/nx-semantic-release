...
describe('Setup project', () => {
  ...
  it('should setup project', async () => {
    await runNxCommandAsync(
      `generate @goestav.x/nx-semantic-release:setup-project ${project}`
    );
  ...
  it('should setup project using given configuration', async () => {
    await runNxCommandAsync(
      `generate @goestav.x/nx-semantic-release:setup-project ${project} --github=false --changelog=false --npm=false --tagFormat=test`
    );
  ...
  it('should create valid project configuration that can be released', async () => {
    await runNxCommandAsync(
      `generate @goestav.x/nx-semantic-release:setup-project ${project} --github=false --changelog=true --npm=true`
    );
